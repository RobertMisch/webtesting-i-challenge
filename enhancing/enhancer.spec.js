...
describe("enhancer", () => {
    ...
    describe("get()", () => {
        it("should be [10]name", () => {
            testItem.enhancments = 10
            testItem.name = 'iron sword'
            expect(enhancer.get(testItem).name).toBe('[10]iron sword');
        });
        it("should be name", () => {
            testItem.enhancments = 0
            testItem.name = 'iron sword'
            expect(enhancer.get(testItem).name).toBe('iron sword');
        });
    })
})
//extra ex from lecture 
